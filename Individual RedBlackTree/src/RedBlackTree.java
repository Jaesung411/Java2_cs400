 ...
 protected void enforceRBTreeProperiesAfterInsert(Node<T> newNode) {
    	...
    	if(newNode.parent==null) {
    		...
    		if(newNode.parent != null && newNode.parent.parent != null) {
		    	...
		    	if(newNode.blackHeight==0 && newNode.parent.blackHeight==0){
		    		...
		    		//null node considers a black node
		    		if(newNode.parent.parent.leftChild == null 
		    			...
		    			if((newNode.equals(newNode.parent.rightChild)
		    					&&newNode.parent.equals(newNode.parent.parent.leftChild))
		    					|| (newNode.equals(newNode.parent.leftChild)
		    						&&newNode.parent.equals(newNode.parent.parent.rightChild))) {
   ...
   private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
    ...
    public void test1() {
    	...
    	assertEquals(1,rbTree.root.leftChild.blackHeight);
    	assertEquals(1,rbTree.root.rightChild.rightChild.blackHeight);
    ...
    public void test2() {
    	...
    	assertEquals(20, rbTree.root.leftChild.toInteger());
    ...
    public void test3() {
    	...
    	assertEquals(70, rbTree.root.rightChild.rightChild.leftChild.toInteger());
